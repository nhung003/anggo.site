    ...
    <div class="container">
        ...
        <section class="main">
            <section class="oder-product">
                <div class="title">
                    <section class="main-order">
                        ...
                        <div class="box">
                            <img src="<?= 'admin/product/' . $product['thumbnail'] ?>" alt="" style="margin-right: 50px;height: 450px;">
                            <div class="about">
                                <h1><?= $product['title'] ?></h1>
                                <style>
                                    p ul{
                        ...
                        foreach ($productList as $item) {
                            echo '
                                    ...
                                    <a href="details.php?id=' . $item['id'] . '">
                                        <img src="admin/product/' . $item['thumbnail'] . '" alt="" class="" style="margin-left:-12px height: 320px;">
                                        <div class="about">
                                            <div class="title">
                                                <p>' . $item['title'] . '</p>
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Thực đơn tại quán <span class="green">Ăng Go</span></h1>
                </div>
                    ...
                    <div class="row">
                        ...
                        foreach ($productList as $item) {
                            echo '
                                <div class="col">
                                    <a href="details.php?id=' . $item['id'] . '">
                                        <img class="thumbnail" src="admin/product/' . $item['thumbnail'] . '" alt="" style="height:320px">
                                        <div class="title">
                                            <p>' . $item['title'] . '</p>
                                        </div>
                                        <div class="price">
