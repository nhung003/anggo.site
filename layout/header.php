...
<body>
    <div id="wrapper">
        <header>
            <div class="container">
                <section class="logo" style="margin: 0 50px;"> 
                    <a href="index.php"><img src="images/logo.png" alt="" style="border-radius: 45%; height: 100px; width: 100px;  "></a>
                </section>
